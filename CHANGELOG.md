...
- Proxmox host installer (`deploy/proxmox/install.sh`) that can be `curl | bash`'d from GitHub: creates the LXC or VM and fully builds FPS inside it (web UI + API on Fry, Docker + agent on Homer).
